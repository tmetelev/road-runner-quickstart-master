        ...
        switch (height) {
            case ZERO:
                Trajectory trajectoryDown = drive.trajectoryBuilder(startPose, 0)
                        .splineToSplineHeading(new Pose2d(-0, 58, 0), 0)
                        .build();
                ...
                Trajectory down = drive.trajectoryBuilder(downtoshoot.end())
...
//                        .build();
                ...
                Trajectory downpark = drive.trajectoryBuilder(down.end())
...
//                R.modeW = Robot20.Wobble_mode.UP;
            ...
            case ONE:
                Trajectory trajectoryMid = drive.trajectoryBuilder(startPose)
                        ...
                        .splineToSplineHeading(new Pose2d(22, 43, Math.toRadians(-30)), Math.toRadians(-30))
                        .build();

                Trajectory midtoshoot = drive.trajectoryBuilder(trajectoryMid.end())
                        .lineToLinearHeading(new Pose2d(-6, 44, Math.toRadians(0)))
                        .build();
                ...
                Trajectory midtoshoot2 = drive.trajectoryBuilder(midtozah.end())
                        .lineToLinearHeading(new Pose2d(-5 , 44, Math.toRadians(0)))
                        .build();
...
//                R.modeW = Robot20.Wobble_mode.UP;
            ...
            case FOUR:
                Trajectory trajectoryHigh = drive.trajectoryBuilder(startPose)
                        .splineToSplineHeading(new Pose2d(-24, 51, 0), 0)
                        .splineToSplineHeading(new Pose2d(50, 58, 0), 0)
                        .build();

                Trajectory hightoshoot = drive.trajectoryBuilder(trajectoryHigh.end())
                        .lineToLinearHeading(new Pose2d(-7, 52, Math.toRadians(0)))
                        .build();
                ...
                Trajectory hightozah1 = drive.trajectoryBuilder(new Pose2d(-23, 36))
                        .lineToLinearHeading(new Pose2d(-5 , 44, 0))
                        .build();

                Trajectory hightozah2 = drive.trajectoryBuilder(new Pose2d(-25, 36))
                        .lineToLinearHeading(new Pose2d(-5 , 44, 0))
                        .build();

                Trajectory hightozah3 = drive.trajectoryBuilder(hightozah1.end())
                        .lineToLinearHeading(new Pose2d(-5, 36, 0))
                        .build();
...
//                telemetry.update();
        ...
        telemetry.addData("x", Robot20.current_pose_static.getX());
        telemetry.addData("y", Robot20.current_pose_static.getY());
        telemetry.addData("head", Robot20.statr_ang);
        telemetry.update();
    }
