 ...
 *
 */
public class RobotLocalizer extends TwoTrackingWheelLocalizer {
...
//
    public static double PARALLEL_X = 9 / 2.54; // X is the up and down direction 9.8 10.4
    public static double PARALLEL_Y = 1 / 2.54; // Y is the strafe direction 1 0

//    public static double PERPENDICULAR_X = 2 / 2.54;
//    public static double PERPENDICULAR_Y = 6 / 2.54;

    public static double PERPENDICULAR_X = 3.5 / 2.54; // 4.2 4.8
    public static double PERPENDICULAR_Y = 4.5 / 2.54; // 6 5.8
    ...
    public RobotLocalizer(HardwareMap hardwareMap, Odo drive) {
        super(Arrays.asList(
